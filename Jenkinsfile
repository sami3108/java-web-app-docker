node{
    ...
    stage('Push Docker Image'){
      ...
      stage('Run Docker Image In Dev Server'){
        ...
        def dockerRun = ' docker run  -d -p 8080:8080 --name java-web-app-1 samikshasuryawanshi/java-web-app-docker'
         
         sshagent(['DOCKER_SERVER']) {
          sh 'ssh -o StrictHostKeyChecking=no ubuntu@192.168.0.53 docker stop java-web-app-1 || true'
          sh 'ssh  ubuntu@192.168.0.53 docker rm java-web-app-1 || true'
